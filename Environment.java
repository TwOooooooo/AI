...
public class Environment {
	...
	public void addAgent(Agent agent, String location) {
		...
		// location thá»±c sá»± láº¥y tá»« Ä‘Ã¢y, nÃªn envState.getAgentLocation lÃ  gá»‘c.
	}
	...
	// Dá»±a vÃ o success Action Ä‘á»ƒ láº¥y action ra
	...
	// percept dc Äƒn á»Ÿ Ä‘Ã¢y
	public Percept getPerceptSeenBy() {
		String location = envState.getAgentLocation(); //A
		return new Percept(location, envState.getLocationState(location)); //váº­y envState truyá»�n cho percept(cháº¯c cháº¯n)
		// envState.getLocationState(location): láº¥y tá»« constructor cá»§a envState trong map put sá»‘ 1
	}

	public void step() {
		envState.display();
		String agentLocation = this.envState.getAgentLocation(); //mai khai thÃ¡c chá»— nÃ y! -!important
		Action anAction = agent.execute(getPerceptSeenBy()); // execute theo percept do agent thá»±c hiá»‡n (anAction luÃ´n luÃ´n dc thá»±c hiá»‡n thÃ nh cÃ´ng do Ä‘á»‡ quy)
		EnvironmentState es = executeAction(anAction); // cáº­p nháº­t tráº¡ng thÃ¡i cá»§a mÃ´i trÆ°á»�ng theo hÃ nh Ä‘á»™ng mÃ  agent thá»±c hiá»‡n
